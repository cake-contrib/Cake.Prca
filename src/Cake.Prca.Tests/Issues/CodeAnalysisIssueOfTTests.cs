namespace Cake.Prca.Tests.Issues
{
    ...
    public class CodeAnalysisIssueOfTTests
    {
        ...
        public sealed class TheCodeAnalysisIssueOfTCtorWithRuleId
        {
            [Theory]
            [InlineData(@"foo<bar")]
            public void Should_Throw_If_File_Path_Is_Invalid(string filePath)
            {
                ...
                var result =
                    Record.Exception(() =>
                        new CodeAnalysisIssue<FakeCodeAnalysisProvider>(filePath, 100, "Foo", 1, "Bar", new Uri("https://google.com")));
            ...
            public void Should_Throw_If_Line_Is_Negative()
            {
                ...
                var result =
                    Record.Exception(() =>
                        new CodeAnalysisIssue<FakeCodeAnalysisProvider>(@"src\foo.cs", -1, "Foo", 1, "Bar", new Uri("https://google.com")));
            ...
            public void Should_Throw_If_Line_Is_Zero()
            {
                ...
                var result =
                    Record.Exception(() =>
                        new CodeAnalysisIssue<FakeCodeAnalysisProvider>(@"src\foo.cs", 0, "Foo", 1, "Bar", new Uri("https://google.com")));
            ...
            public void Should_Throw_If_Line_Is_Set_But_No_File()
            {
                ...
                var result =
                    Record.Exception(() =>
                        new CodeAnalysisIssue<FakeCodeAnalysisProvider>(null, 10, "Foo", 1, "Bar", new Uri("https://google.com")));
            ...
            public void Should_Throw_If_Message_Is_Null()
            {
                ...
                var result =
                    Record.Exception(() =>
                        new CodeAnalysisIssue<FakeCodeAnalysisProvider>(@"src\foo.cs", 100, null, 1, "Bar", new Uri("https://google.com")));
            ...
            public void Should_Throw_If_Message_Is_Empty()
            {
                ...
                var result =
                    Record.Exception(() =>
                        new CodeAnalysisIssue<FakeCodeAnalysisProvider>(@"src\foo.cs", 100, string.Empty, 1, "Bar", new Uri("https://google.com")));
            ...
            public void Should_Throw_If_Message_Is_WhiteSpace()
            {
                ...
                var result =
                    Record.Exception(() =>
                        new CodeAnalysisIssue<FakeCodeAnalysisProvider>(@"src\foo.cs", 100, " ", 1, "Bar", new Uri("https://google.com")));
            ...
            public void Should_Throw_If_Rule_Is_Null()
            {
                ...
                var result =
                    Record.Exception(() =>
                        new CodeAnalysisIssue<FakeCodeAnalysisProvider>(@"src\foo.cs", 100, "foo", 1, null, new Uri("https://google.com")));
            ...
            {
                // Given / When
                var issue = new CodeAnalysisIssue<FakeCodeAnalysisProvider>(null, null, "Foo", 1, "Bar", new Uri("https://google.com"));
            ...
            {
                // Given / When
                var issue = new CodeAnalysisIssue<FakeCodeAnalysisProvider>(string.Empty, null, "Foo", 1, "Bar", new Uri("https://google.com"));
            ...
            public void Should_Set_Rule_Url()
            {
                ...
                // When
                var issue = new CodeAnalysisIssue<FakeCodeAnalysisProvider>(@"foo.cs", 100, "foo", 1, "foo", ruleUrl);
